    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        *** See   dimensions.pdf   to understand the following! ***
        ...
        h1 = rg.Point(intersection_center.x - (width / 2), intersection_center.y + (letter_thickness / 2))
        h2 = rg.Point(intersection_center.x + (width / 2), intersection_center.y - (letter_thickness / 2))
        self.h_rect = rg.Rectangle(h1, h2)
        v1 = rg.Point(intersection_center.x - (letter_thickness / 2), intersection_center.y - (letter_thickness / 2))
        v2 = rg.Point(v1.x + letter_thickness, v1.y + height)
    ...
    def clone(self):
        ...
        #######################################################################
        t = CapitalT(self.intersection_center, self.height, self.width, self.letter_thickness)
